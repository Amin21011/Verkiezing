...
public class ResultLoader {
    ...
    public static void loadResults(Election election, ResultRepository repository) throws Exception {
        ...
        if (folderUrl == null) {
            throw new IllegalStateException("Map TK2023_HvA_UvA niet gevonden in resources!");
        }

        File folder = new File(folderUrl.toURI());
        File[] candidateFiles = folder.listFiles((dir, name) ->
                name.toLowerCase().startsWith("kandidatenlijsten_") && name.endsWith(".eml.xml"));
        ...
        System.out.printf("%d partijen en %d unieke kandidaten geladen.%n",
                election.getParties().size(), totalCandidates);
                ...
                while (reader.hasNext()) {
                    ...
                    if (event == XMLStreamConstants.START_ELEMENT) {
                        ...
                        switch (name) {
                            ...
                            case "CandidateIdentifier" -> {
                                ...
                                System.out.printf("↪ Candidate gevonden: %s (partij %s)%n", candidateId, currentAffiliationId);
                            }
                    ...
                    if (event == XMLStreamConstants.END_ELEMENT) {
                        ...
                        if ("Selection".equals(name)) {
                            if (currentAffiliationId != null && !selectionData.containsKey("AffiliationIdentifier-Id")) {
                                selectionData.put("AffiliationIdentifier-Id", currentAffiliationId.trim());
                            }
