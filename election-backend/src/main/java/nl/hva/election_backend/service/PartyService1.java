...
@Service
public class PartyService1 {
    // partijen opslaan
    private List<Party1> parties;


    public PartyService1() {
        // Hardcoded-data van partijen 2025
        //TODO: ZET EEN LANGER DESCRIPTION!!!!
        parties = new ArrayList<>();
        parties.add(new Party1(1L, "PVV",
        ...
        parties.add(new Party1(2L, "GROENLINKS / PvdA",
        ...
        parties.add(new Party1(4L, "Nieuw Sociaal Contract (NSC)",
        ...
        parties.add(new Party1(9L, "DENK",
        ...
        parties.add(new Party1(10L, "Partij voor de Dieren",
        ...
        parties.add(new Party1(11L, "Forum voor Democratie",
        ...
        parties.add(new Party1(12L, "SGP",
        ...
        parties.add(new Party1(13L, "ChristenUnie",
        ...
        parties.add(new Party1(14L, "Volt",
        ...
        parties.add(new Party1(15L, "JA21",
        ...
        parties.add(new Party1(16L, "Vrede voor Dieren",
        ...
        parties.add(new Party1(17L, "BVNL",
        ...
        parties.add(new Party1(18L, "BIJ1",
        ...
        parties.add(new Party1(20L, "50PLUS",
        ...
        parties.add(new Party1(21L, "Piratenpartij",
        ...
        parties.add(new Party1(22L, "FNP",
        ...
        parties.add(new Party1(23L, "Vrij Verbond",
        ...
        parties.add(new Party1(24L, "DE LINIE",
        ...
        parties.add(new Party1(25L, "NL PLAN",
        ...
        parties.add(new Party1(26L, "ELLECT",
        ...
        parties.add(new Party1(27L, "Partij voor de Rechtsstaat",
    ...
    public List<Party1> getAllPartiesRandomized() {
        List<Party1> shuffled = new ArrayList<>(parties);
        Collections.shuffle(shuffled);
        return shuffled;
    }
    // zoek in de lijst naar de partij met het juiste id
    public Party1 getPartyById(Long id) {
